...
public class AirportController {
    ...
    @PostMapping
    ResponseEntity<AirportDto> createPassenger(@RequestBody AirportDto airportDto) {
        return ResponseEntity.ok(airportService.createAirport(airportDto));
    }

    @PutMapping("/update")
    ResponseEntity<AirportDto> updatePassenger(@RequestBody AirportDto airportDto) {
