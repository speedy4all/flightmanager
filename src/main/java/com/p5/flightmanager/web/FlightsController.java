...
//    }
    ...
    ResponseEntity<ListResponseDto<ResponseFlightDto>> getFlightsByUniqueIdentifier(@PathVariable String identifyNumber) {
        return ResponseEntity.ok(flightService.getFlightsByUniqueIdentifier(identifyNumber));
    }
    ...
    @GetMapping("/offers")
    Iterable<FlightDtoView> getOffers(String destinationLocation){
